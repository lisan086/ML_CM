...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 6da313e9-fad8-454b-b656-b142bd4af430
```

> `6da313e9-fad8-454b-b656-b142bd4af430` is the password of the certificate, you can change it to any password you want.
